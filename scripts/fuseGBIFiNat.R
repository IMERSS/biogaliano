...
gbifNotINat <- timedRead("../data/synthesized/Galiano_GBIF_Not_iNat_2025_03_17.csv")
gbifNotUnion <- timedRead("../data/synthesized/Galiano_GBIF_Not_Union_2025_03_17.csv")
iNat <- timedRead("../data/synthesized/Galiano_Union_Catalogue_2025_03_14.csv")

gbif <- bind_rows(gbifNotINat, gbifNotUnion)
...
iNatNext <- iNat %>% mutate(decimalLatitude = round(as.numeric(coalesce(private_latitude, latitude)), 6)) %>%
...
timedWrite(accepted, "../data/synthesized/Galiano_GBIF_And_iNat_2025_03_17.csv")
